...
opts_chunk$set(comment = NA, fig.show='hold', fig.height=7, fig.width=7, 
               highlight = TRUE, tidy = TRUE, tidy.opts=list(blank = FALSE, width.cutoff= 55))
@
...
\bibliographystyle{chicago} % Use the "unsrtnat" BibTeX style for formatting the Bibliography ....plainnat....chicago 
